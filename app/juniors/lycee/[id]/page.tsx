...
import { getLyceeCourseById } from "@/lib/mock-data";
...
export default async function CourseDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* Header avec retour */}
      <div className="mb-8">
        <Link href="/juniors/lycee">
          <button className="flex items-center gap-2 text-secondary hover:text-orange-600 transition-colors mb-6 font-semibold">
