      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            ...
            >
              <Card padding="none" className="flex flex-col group overflow-hidden hover:border-blue-200 transition-colors cursor-pointer h-full hover:shadow-lg">
                <div className="p-6 flex-1 flex flex-col relative overflow-hidden">
                  ...
                  <h2 className="font-display font-bold text-secondary text-lg mb-3 leading-snug group-hover:text-blue-500 transition-colors relative z-10">
                    {course.titre}
                  </h2>
