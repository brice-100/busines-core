...
import { getCollegeCourseById } from "@/lib/mock-data";
...
export default async function CourseDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* Header avec retour */}
      <div className="mb-8">
        <Link href="/juniors/college">
          <button className="flex items-center gap-2 text-secondary hover:text-blue-600 transition-colors mb-6 font-semibold">
